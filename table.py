...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label.setGeometry(QtCore.QRect(180, 35, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.unit = QtWidgets.QLineEdit(Form)
        self.unit.setGeometry(QtCore.QRect(40, 30, 131, 31))
        self.unit.setObjectName("unit")
        self.perunit = QtWidgets.QLineEdit(Form)
        self.perunit.setGeometry(QtCore.QRect(270, 30, 131, 31))
        self.perunit.setObjectName("perunit")
        self.label_2 = QtWidgets.QLabel(Form)
        self.label_2.setGeometry(QtCore.QRect(410, 35, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Scale Table"))
        self.label.setText(_translate("Form", "cm"))
        self.label_2.setText(_translate("Form", "p.u."))
